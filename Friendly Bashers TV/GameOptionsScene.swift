...
class GameOptionsScene:SKScene {
    ...
    func updateUI() {
        ...
        if chosenBlessing == 0 {
            chooseBlessingPage1?.run(SKAction.setTexture(SKTexture(imageNamed: "Button_Selected")))
            ...
            chooseBlessingPage2?.run(SKAction.setTexture(SKTexture(imageNamed: "Button_Selected")))
            chooseBlessingPage3?.run(SKAction.setTexture(SKTexture(imageNamed: "Button_Enabled")))
            chooseBlessingPage4?.run(SKAction.setTexture(SKTexture(imageNamed: "Button_Enabled")))
        } else if chosenBlessing == 2 {
            chooseBlessingPage1?.run(SKAction.setTexture(SKTexture(imageNamed: "Button_Enabled")))
            chooseBlessingPage2?.run(SKAction.setTexture(SKTexture(imageNamed: "Button_Enabled")))
            chooseBlessingPage3?.run(SKAction.setTexture(SKTexture(imageNamed: "Button_Selected")))
            chooseBlessingPage4?.run(SKAction.setTexture(SKTexture(imageNamed: "Button_Enabled")))
        } else if chosenBlessing == 3 {
            chooseBlessingPage1?.run(SKAction.setTexture(SKTexture(imageNamed: "Button_Enabled")))
            chooseBlessingPage2?.run(SKAction.setTexture(SKTexture(imageNamed: "Button_Enabled")))
            chooseBlessingPage3?.run(SKAction.setTexture(SKTexture(imageNamed: "Button_Enabled")))
            chooseBlessingPage4?.run(SKAction.setTexture(SKTexture(imageNamed: "Button_Selected")))
        }
        
        if deathMode == 1 {
            deathMode1Button?.run(SKAction.setTexture(SKTexture(imageNamed: "Button_Selected")))
            ...
            deathMode2Button?.run(SKAction.setTexture(SKTexture(imageNamed: "Button_Selected")))
        }
    }
}
