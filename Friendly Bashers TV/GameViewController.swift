        ...
        for p in presses {
            if mainMenu != nil {
                if !mainMenu!.isPaused {
                    mainMenu?.receivedPress(press: p.type)
                }
            }
            
            if modeSelect != nil {
                if !modeSelect!.isPaused {
                    modeSelect?.receivedPress(press: p.type)
                }
            }
            
            if basherSelect != nil {
                if !basherSelect!.isPaused {
                    basherSelect?.receivedPress(press: p.type)
                }
            }
        }
    }
