...
class BlessingsScene:SKScene, UITextFieldDelegate {
    ...
    func updateUI() {
        ...
        if blessingNames[0] != "Page 1" {
            deletePage1?.run(SKAction.setTexture(SKTexture(imageNamed: "Button_Delete")))
        } else {
            deletePage1?.run(SKAction.setTexture(SKTexture(imageNamed: "Button_Delete_Grey")))
        }
        
        if blessingNames[1] != "Page 2" {
            deletePage2?.run(SKAction.setTexture(SKTexture(imageNamed: "Button_Delete")))
        } else {
            deletePage2?.run(SKAction.setTexture(SKTexture(imageNamed: "Button_Delete_Grey")))
        }
        
        if blessingNames[2] != "Page 3" {
            deletePage3?.run(SKAction.setTexture(SKTexture(imageNamed: "Button_Delete")))
        } else {
            deletePage3?.run(SKAction.setTexture(SKTexture(imageNamed: "Button_Delete_Grey")))
        }
        
        if blessingNames[3] != "Page 4" {
            deletePage4?.run(SKAction.setTexture(SKTexture(imageNamed: "Button_Delete")))
        } else {
            deletePage4?.run(SKAction.setTexture(SKTexture(imageNamed: "Button_Delete_Grey")))
        }
